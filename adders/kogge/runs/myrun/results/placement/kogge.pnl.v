module kogge (VPWR,
 ...
 sky130_fd_sc_hd__nor2_1 _096_ (.A(_051_),
    ...
    .VPWR(VPWR),
    .Y(net33));
 sky130_fd_sc_hd__xor2_1 _097_ (.A(net24),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _105_ (.A(net25),
    ...
    .VPWR(VPWR),
    .Y(_059_));
 sky130_fd_sc_hd__a221oi_1 _106_ (.A1(net25),
    .A2(net9),
    .B1(_052_),
    .B2(_053_),
    .C1(_054_),
 ...
 sky130_fd_sc_hd__xor2_1 _115_ (.A(_063_),
    ...
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__xor2_1 _116_ (.A(net28),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 input11 (.A(A[4]),
    ...
    .VPWR(VPWR),
    .X(net11));
 sky130_fd_sc_hd__dlymetal6s2s_1 input12 (.A(A[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 input24 (.A(B[1]),
    ...
    .VPWR(VPWR),
    .X(net24));
 sky130_fd_sc_hd__dlymetal6s2s_1 input25 (.A(B[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 input27 (.A(B[4]),
    ...
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__dlymetal6s2s_1 input28 (.A(B[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
