module mbe (A,
 ...
 sky130_fd_sc_hd__or4_4 _297_ (.A(net1),
    ...
    .D(net4),
    .X(_231_));
 sky130_fd_sc_hd__buf_8 _298_ (.A(_231_),
    .X(_232_));
 ...
 sky130_fd_sc_hd__buf_2 output32 (.A(net32),
    .X(P[9]));
 sky130_fd_sc_hd__clkbuf_2 wire33 (.A(_168_),
    .X(net33));
 sky130_fd_sc_hd__buf_1 max_cap34 (.A(_065_),
    .X(net34));
 sky130_fd_sc_hd__clkbuf_2 max_cap35 (.A(_240_),
    .X(net35));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer1 (.A(_027_),
    .X(net36));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(net36),
    .X(net37));
 sky130_fd_sc_hd__clkbuf_2 rebuffer3 (.A(_014_),
    .X(net38));
 sky130_fd_sc_hd__clkbuf_1 rebuffer4 (.A(_103_),
    .X(net39));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer5 (.A(_106_),
    .X(net40));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer6 (.A(_069_),
    .X(net41));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer7 (.A(net41),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer8 (.A(_069_),
    .X(net43));
endmodule
